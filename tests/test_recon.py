from gridx.recon import build_re_dict, build_outage_dict, build_storms_dict
from pathlib import Path
import pandas as pd

def test_build_re_dict():
    actual_path = Path("data/renewables/prod_btu_re_te.xlsx")
...
def test_build_outage_dict():
    actual_path = Path("data/outages/2016_Annual_Summary.xls")
...
def test_build_storms_dict():
    test_path = Path("data/storms/storms_2020.csv")
